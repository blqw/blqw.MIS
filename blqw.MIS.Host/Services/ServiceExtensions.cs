...
namespace blqw.MIS
{
    ...
    public static class ServiceExtensions
    {
        ...
        /// <returns></returns>
        public static T GetServiceInstance<T>(this T service, bool required)
            where T : IService
        {
            if (service == null)
            {
            ...
            if (!service.RequireClone) return service;
            var newService = (T)service.Clone();
            if (newService == null && required)
            {
